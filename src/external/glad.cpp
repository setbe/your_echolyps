/*
    ...
    OpenGL loader generated by glad 0.1.36 on Tue Apr 15 10:18:24 2025.
...
static constexpr int max_loaded_major = 3;
static constexpr int max_loaded_minor = 3;
...
static void load_GL_VERSION_1_0(GLADloadproc load) {
    ...
    // (PFNGLTEXPARAMETERFVPROC)load("glTexParameterfv"); glad_glTexParameteri =
    // (PFNGLTEXPARAMETERIPROC)load("glTexParameteri"); glad_glTexParameteriv =
    // (PFNGLTEXPARAMETERIVPROC)load("glTexParameteriv"); glad_glTexImage1D =
    // (PFNGLTEXIMAGE1DPROC)load("glTexImage1D"); glad_glTexImage2D =
    // (PFNGLTEXIMAGE2DPROC)load("glTexImage2D"); glad_glDrawBuffer =
...
static void load_GL_VERSION_1_1(GLADloadproc load) {
    ...
    // (PFNGLDELETETEXTURESPROC)load("glDeleteTextures"); glad_glGenTextures =
    // (PFNGLGENTEXTURESPROC)load("glGenTextures"); glad_glIsTexture =
    // (PFNGLISTEXTUREPROC)load("glIsTexture");
}
...
static void load_GL_VERSION_1_4(GLADloadproc load) {
    ...
    // (PFNGLPOINTPARAMETERIVPROC)load("glPointParameteriv"); glad_glBlendColor
    // = (PFNGLBLENDCOLORPROC)load("glBlendColor"); glad_glBlendEquation =
...
static void load_GL_VERSION_1_5(GLADloadproc load) {
    ...
    // (PFNGLGETBUFFERSUBDATAPROC)load("glGetBufferSubData"); glad_glMapBuffer =
    // (PFNGLMAPBUFFERPROC)load("glMapBuffer"); glad_glUnmapBuffer =
    // (PFNGLUNMAPBUFFERPROC)load("glUnmapBuffer"); glad_glGetBufferParameteriv
...
static void load_GL_VERSION_3_2(GLADloadproc load) {
    ...
    // (PFNGLPROVOKINGVERTEXPROC)load("glProvokingVertex"); glad_glFenceSync =
    // (PFNGLFENCESYNCPROC)load("glFenceSync"); glad_glIsSync =
    // (PFNGLISSYNCPROC)load("glIsSync"); glad_glDeleteSync =
    // (PFNGLDELETESYNCPROC)load("glDeleteSync"); glad_glClientWaitSync =
    ...
    // (PFNGLGETMULTISAMPLEFVPROC)load("glGetMultisamplefv"); glad_glSampleMaski
    // = (PFNGLSAMPLEMASKIPROC)load("glSampleMaski");
}
static void load_GL_VERSION_3_3(GLADloadproc load) {
    ...
    // (PFNGLGETFRAGDATAINDEXPROC)load("glGetFragDataIndex"); glad_glGenSamplers
    // = (PFNGLGENSAMPLERSPROC)load("glGenSamplers"); glad_glDeleteSamplers =
